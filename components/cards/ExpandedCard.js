...
const ExpandedCard = ({ canRsvp, event, src, date, blurb, location, numberOfGuests, name, objectPosition, onClick }) => {
        ...
        <motion.div className="h-screen w-screen absolute z-30 bg-white">
            <div className="h-full w-full">
                <div className="absolute h-full sm:h-4/5 xl:h-5/6 w-full sm:w-4/5 2xl:w-1/2 sm:inset-y-1/20 sm:inset-x-1/10 2xl:inset-x-1/4 m-auto rounded-md">
                    <CardPhoto src={src} heading={event} className="h-1/3 lg:h-2/5 lg:rounded-t-lg" onClick={onClick} objectPosition={objectPosition} />
                    <motion.div className="h-2/3 lg:h-3/5 px-10 shadow-md lg:rounded-b-lg"
                        ...
                        <div className="relative h-full">
                            ...
                            {canRsvp && (
                                <form className="mt-5 2xl:text-lg absolute bottom-10 w-full">
